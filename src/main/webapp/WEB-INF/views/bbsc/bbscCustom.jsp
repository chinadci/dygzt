    ...
    <div id="main">
        ...
        <div id="right">
            ...
            <div class="mod-content wrap3 bbscform form4">
                <div class="formrow">
                    <a class="toggle-btn" id="toggle-btn">
                        <sapn>收起筛选</sapn>
                    </a>
                </div>
                <div id="expend-list">
                    <div class="formrow">
                        ...
                        <label class="check-item"><input type="checkbox" name="yjCondition" data-lx="ajzt" value="旧存">
                            旧存</label>
                        <label class="check-item"><input type="checkbox" name="yjCondition" data-lx="ajzt" value="已结">
                            已结</label>
                        <label class="check-item"><input type="checkbox" name="yjCondition" data-lx="ajzt" value="未结">
                            未结</label>
                    </div>
                    <div class="formrow">
                        ...
                        <div style="display:inline-block;width:80%">
                            ...
                            <div class="ejl-list">
                                <c:forEach var="lb" items="${lbList }" varStatus="status">
                                    <a data-bbbh="${lb}" class="btn2"
                                       href="javascript:void(0)">${lbmcList[status.index]}</a>
                                </c:forEach>
                            </div>
                            <!-- 下级展开 -->
                            <div>
                                <c:forEach var="lb" items="${lbList }">
                                    <div data-bbbh="${lb}" class="expand-list">
                                        <c:forEach var="xx" items="${xxbbMap.get(lb) }">
                                            <input type="checkbox" name="xxx" data-bbbh="${lb}" data-xxmc="${xx.xxmc}"
                                                   data-xsmc="${xx.xsmc}">${xx.xsmc}
                                        </c:forEach>
                                    </div>
                                </c:forEach>
                            </div>
