					...
					<table id="table">
						<thead>
							<tr>
								...
								<th style="width:80px">统计人</th>
								<th style="width:140px">统计人法院</th>
...
<script type="text/javascript">
	...
	$("#table").DataTable({
		...
		"bSort":true,	//排序
		"aoColumnDefs": [ { "bSortable": false, "aTargets": [ 6 ] }],	//第一列从0开始,序号为6列的列(最后一列即操作列)不进行排序，别的列均可进行排序
		"bInfo" : true,	//页脚信息
		"paging":true,	//分页
		...
		"language": {
		 ...
		 "bServerSide" : true,
		 "sAjaxSource": "bbscAutoSearchList.aj?${ condition }",
		 "aoColumns": [
		 	{ "mDataProp": "dyrq" },
		 	{ "mDataProp": "bgmc" },
		 	{ "mDataProp": "ksrq" },
