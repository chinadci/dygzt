...
<body>
	<div id="content">
		...
		<div id="main">
			<div class="mod-content wrap3 manualtable">
				<h3 class="title" style="margin-left:20px">
					<s class="file"></s>人工调研列表
				</h3>
...
<script type="text/javascript" src="resources/js/manual/manualStatisticTable.js"></script>
<script type="text/javascript">
	init_body();
	setRemainingHeight(".manualtable","#main");
	var tableHeight = $(".manualtable").height()-$(".table-4").position().top-parseInt($(".table-4").css("margin-top"))-parseInt($(".table-4").css("margin-bottom"))-84;//26(表头)+26(info)+32(分页)=84
	$("#table").DataTable({
		...
		"language": {
		 ...
		 "bServerSide" : true,
		 "sAjaxSource": "manualSearchList.aj?${ condition }",
		 "aoColumns": [
		 	{ "mDataProp": "dyrq" },
		 	{ "mDataProp": "dymd" },
		 	{ "mDataProp": "ksrq" },
