	...
	<div id="main">
		...
		<div id="right">
			...
			<div class="mod-content wrap3 persontable">
				<div class="table-2">
				<a class="btn1 datatablebtn" href="addPerson.do">新增</a>
				<table id="table">
					<thead>
						<tr>
							<th>序号</th>
...
var tableHeight = $(".persontable").height()-parseInt($(".table-2").css("margin-top"))-parseInt($(".table-2").css("margin-bottom"))-125; //36(搜索框)+31(表头)+26(info)+32(分页)=125
	$("#table").DataTable({
		...
		"aoColumnDefs": [ { "bSortable": false, "aTargets": [ 7 ] }],	//第一列从0开始,序号为7列的列不进行排序，别的列均可进行排序
		...
		"language": {
		 ...
		 "bServerSide" : true,
		 "sAjaxSource": "changePersonList.aj",
		 "aoColumns": [
		 	{ "mDataProp": "xh" },
		 	{ "mDataProp": "fymc" },
		 	{ "mDataProp": "yhm" },
