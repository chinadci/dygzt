			...
			<div class="mod-content wrap3 autoform">
				<form action="/showAutoSearchTable.aj" method="post" class="searchform form1">
					<div>
						...
						<label class="col10">调研人:</label>
						<input name="dyr" id = "dyr" type="text" class="col10"/>
					</div>
					<div>
					    <label class="col10">调研人法院:</label>
					...
					<table id="table">
						<thead>
							<tr>
								...
								<th style="width:70px">调研人</th>
								<th style="width:120px">调研人法院</th>
...
<script src="resources/js/research/autoSearch.js"></script>
</html>
