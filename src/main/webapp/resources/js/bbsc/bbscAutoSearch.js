...
function initTable2(){
	...
	$("#table").DataTable({
		...
		"bSort":true,	//排序
		"aoColumnDefs": [ { "bSortable": false, "aTargets": [ 6 ] }],	//第一列从0开始,序号为5的列(即第六列)不进行排序，别的列均可进行排序
		"bInfo" : true,	//页脚信息
		"paging":true,	//分页
		...
		"language": {
		 ...
		 "bServerSide" : true,
		 "sAjaxSource": "bbscAutoSearchList.aj?"+$(".searchform").serialize(),
		 "aoColumns": [
		 	{ "mDataProp": "dyrq" },
		 	{ "mDataProp": "bgmc" },
		 	{ "mDataProp": "ksrq" },
		 	{ "mDataProp": "jsrq" },
		 	// { "mDataProp": "ajzt" },//BBSC 中不显示
		 	{ "mDataProp": "dyr" },
		 	{ "mDataProp": "dyrfydm" },
		 	{ "mDataProp": "btn" }
		 ]
