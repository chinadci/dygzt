...
function initTable(){
	var tableHeight= $(".computetable").height()-$(".table-2").position().top-parseInt($(".table-2").css("margin-top"))-parseInt($(".table-2").css("margin-bottom"))-89; //31(表头)+26(info)+32(分页)=125
	$("#table").DataTable({
		...
		"language": {
		 ...
		 "bServerSide" : true,
		 "sAjaxSource": "manualComputedList.aj?ksrq="+$("#ksrq").val()+"&jsrq="+$("#jsrq").val(),
		 "aoColumns": [
		 	{ "mDataProp": "dyrq" },
		 	{ "mDataProp": "dymd" },
		 	{ "mDataProp": "ksrq" },
